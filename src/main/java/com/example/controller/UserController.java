...
public class UserController {
    ...
    public Result<User> deleteStu() {
        userService.deleteStu();
        messageService.deleteStu();
        communicateService.deleteStu();
        return Result.success();
    }
     ...
     */
    @GetMapping("/loadmap")
    public Result<Set<MapVo>> loadMap(){
        return Result.success(userService.loadMap());
    }

//    @GetMapping("/loadavatar/userId}")
//    public Result<String> loadAvator(@PathVariable Long userId){
//        return Result.success(userService.loadAvatar(userId));
//    }
     ...
     * @return
     */
    @GetMapping("/loadusernum")
    public Result<Integer> loadStudentNum() {
        QueryWrapper<User> wrapper = new QueryWrapper<>();
        return Result.success(userService.count(wrapper));
    }
...
//        LambdaQueryWrapper<User> wrapper = Wrappers.<User>lambdaQuery().ne(User::getUsername, "admin").like(User::getUsername, name).orderByAsc(User::getId);
        LambdaQueryWrapper<User> wrapper = Wrappers.<User>lambdaQuery().like(User::getUsername, name).orderByAsc(User::getId);
