...
CREATE TABLE `t_user`  (
  ...
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT "[2]" COMMENT '角色',
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'admin', 'admin', '管理员', '111124444@163.com', '13978786565', '1622537239707', '[1]', '北京', NULL);
